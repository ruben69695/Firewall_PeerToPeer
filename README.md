# Firewall Sync
Firewall Sync, this service made with Node.js allows to save Windows firewall rules in a NoSQL Mongo Database and synchronize all the rules with the clients connected by socket to our service. 
